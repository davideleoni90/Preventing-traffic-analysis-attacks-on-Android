...
# select "Create new folder" in the context menu
adb shell input tap 600 1800 1>/dev/null
sleep 1.5
...
adb shell input text $(echo "_${random_string}" | sed -e 's/ /\%s/g')
sleep 1.5

# click on "CREATE" to save the file
