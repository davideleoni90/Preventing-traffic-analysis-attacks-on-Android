...
# for ITERATIONS times capture the traffic generated by the user action triggered by the script; each time, access both the default network and the anonymous Tor network  
...
for ((i=0; i<ITERATIONS; i++)); do
	...
	then
		...
		# sleep before going to the next iteration
		sleep 20
done
